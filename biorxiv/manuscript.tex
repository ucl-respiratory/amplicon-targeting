...
This work was undertaken as part of the Claude Science hackathon in July 2026, sponsored by Anthropic and Gladstone Institutes. We are grateful for their support. The funders had no role in the design of the study, the analysis or interpretation of the results, or the decision to publish.
...
All code is available at \url{https://github.com/ucl-respiratory/amplicon-targeting}. A data-preparation pipeline fetches every input from its primary public source, and an analysis pipeline computes every figure, table and in-text value from those cached layers.
