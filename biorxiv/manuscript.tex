...
If transmissibility is an intrinsic property of a gene, it should be predictable from the gene's own biology, measured independently of any proteomics. Using only gene properties---dosage sensitivity, protein biophysics, mRNA features, evolutionary constraint, complex membership, expression breadth and network centrality, each defined with its data source in Supplementary Table S1\cite{ref16,ref17,ref18}---and a leave-gene-out design in which no gene informs its own prediction, we recover transmissibility at a rank correlation of 0.54 (R$^2$ = 0.32) across 6,926 genes (a marginally smaller set than the 6,979 of the cascade, because a gene enters here only if it has both a defined transmissibility and a complete gene-property feature vector). No protein-derived feature enters the predictor. Two controls establish that this is intrinsic rather than positional or lineage-bound. Holding out whole chromosome arms in turn, so no gene is predicted from a same-arm neighbour, changes the accuracy by only 0.003---the signal is not a positional artefact. And ranking genes by predicted transmission within each held-out lineage, the rankings agree across the six tumour types at a Kendall concordance of 0.87. A gene's transmissibility can therefore be anticipated before its protein is measured, which is what licenses extending the target map to cancer types with no tissue-referenced proteome of their own.

\begin{figure*}[tbp]
\centering
\includegraphics[width=0.98\linewidth]{Figures/fig3_predictor}
\caption{Transmissibility is predictable from gene properties alone (gradient-boosted regressor, 39 gene-property features, no protein-derived input; n = 6,926 genes). (a) Five-fold leave-gene-out out-of-fold predicted versus observed transmissibility (Spearman $\rho$ = 0.54, R$^2$ = 0.32). (b) Positional control: leave-gene-out versus leave-chromosome-arm-out out-of-fold accuracy ($\Delta$$\rho$ = 0.003), showing the signal is not carried by same-arm neighbours. (c) Cross-lineage transfer: agreement of predicted rankings across six leave-one-lineage-out refits (Kendall's W = 0.87, six cancer types).}
\label{fig:fig3_predictor}
\end{figure*}

\subsection*{A quantified funnel from transmissibility to accessible targets}
With the transmission map and the predictor in hand, the full nomination path is a funnel, and every step is quantified from data (Figure 3). It begins with the 6,926 genes carrying both a measured and a predicted transmissibility across the CPTAC cohorts---so the target space is pan-cancer from the outset, not restricted to any one tumour type. Requiring transmission to protein (observed transmissibility $\geq$ 0.40) retains 3,115 genes. Independently, a per-(cohort, cytoband, gene) Fisher test identifies genes whose high tissue-relative protein is enriched in tumours where their band is amplified; 888 genes are co-elevated on a recurrent amplicon in at least one cohort (BH-FDR < 0.1), of which 507 are also transmitted. The last step keeps only genes an antibody could actually reach. An antibody--drug conjugate binds its target from outside the cell, so a useful target must be a membrane protein that displays a substantial portion of its structure---its ectodomain---on the cell surface, outside the lipid bilayer. We therefore apply a surface-accessibility gate: using UniProt topology annotation, we require at least 50 extracellular residues on a membrane-spanning protein. This gate yields the 22 nominated surface antigens, distributed across 18 distinct recurrent amplicons in 4 cancer types. The funnel is pan-cancer at every step; the antigens it yields are detailed next.
...
\midrule
CCRCC & CCRCC\_5q & LNPEP & 0.60 & 0.60 & 87.0 & 894 & 1 & -0.06 & passenger & high \\
CCRCC & CCRCC\_7p & ITGB8 & 0.64 & 0.33 & 228.0 & 642 & 1 & 0.01 & passenger & high \\
CCRCC & CCRCC\_7q & FZD1 & 0.57 & 0.37 & 222.0 & 344 & 7 & 0.01 & passenger & --- \\
LSCC & LSCC\_12p & SLC2A3 & 0.51 & 0.35 & 136.0 & 82 & 12 & -0.07 & passenger & --- \\
LSCC & LSCC\_1q & NCSTN & 0.63 & 0.49 & 201.0 & 636 & 1 & -0.07 & passenger & high \\
LSCC & LSCC\_1q & HSD17B7 & 0.60 & 0.32 & 195.0 & 229 & 1 & -0.12 & passenger & --- \\
LSCC & LSCC\_1q & MPZL1 & 0.52 & 0.30 & 195.0 & 127 & 1 & -0.22 & passenger & high \\
LSCC & LSCC\_20q & TM9SF4 & 0.70 & 0.46 & 165.0 & 299 & 9 & -0.16 & passenger & --- \\
LSCC & LSCC\_3q & TFRC & 0.67 & 0.51 & 167.0 & 672 & 1 & -0.94 & ess. & high \\
LSCC & LSCC\_3q & ATP11B & 0.65 & 0.57 & 179.0 & 80 & 10 & -0.01 & passenger & --- \\
LSCC & LSCC\_5p & LMBRD2 & 0.56 & 0.48 & 191.0 & 123 & 9 & 0.10 & passenger & put. \\
LSCC & LSCC\_7p & TSPAN13 & 0.49 & 0.24 & 230.0 & 78 & 4 & 0.07 & passenger & put. \\
LSCC & LSCC\_8p & SLC20A2 & 0.63 & 0.39 & 122.0 & 82 & 12 & -0.09 & passenger & --- \\
LSCC & LSCC\_8q & FZD6 & 0.49 & 0.39 & 170.0 & 274 & 7 & 0.13 & passenger & --- \\
LUAD & LUAD\_14q & TMX1 & 0.90 & 0.50 & 93.0 & 154 & 1 & -0.25 & passenger & --- \\
LUAD & LUAD\_16p & ABCC1 & 0.70 & 0.38 & 105.0 & 147 & 17 & 0.02 & passenger & high \\
LUAD & LUAD\_17q & VMP1 & 0.86 & 0.67 & 122.0 & 166 & 7 & -1.13 & ess. & --- \\
LUAD & LUAD\_1q & NCSTN & 0.63 & 0.49 & 201.0 & 636 & 1 & -0.07 & passenger & high \\
LUAD & LUAD\_1q & ADAM15 & 0.42 & 0.32 & 199.0 & 490 & 1 & -0.08 & passenger & high \\
LUAD & LUAD\_5p & SLC12A7 & 0.80 & 0.40 & 193.0 & 181 & 12 & -0.02 & passenger & high \\
LUAD & LUAD\_5p & CLPTM1L & 0.64 & 0.42 & 191.0 & 262 & 6 & 0.09 & passenger & put. \\
LUAD & LUAD\_7p & TTYH3 & 0.66 & 0.35 & 224.0 & 275 & 5 & 0.01 & passenger & high \\
LUAD & LUAD\_7p & ITGB8 & 0.64 & 0.33 & 228.0 & 642 & 1 & 0.01 & passenger & high \\
LUAD & LUAD\_7p & EGFR & 0.63 & 0.42 & 232.0 & 621 & 1 & -0.24 & driver & high \\
LUAD & LUAD\_7p & TSPAN13 & 0.49 & 0.24 & 230.0 & 78 & 4 & 0.07 & passenger & put. \\
UCEC & UCEC\_1q & NCSTN & 0.63 & 0.49 & 201.0 & 636 & 1 & -0.07 & passenger & high \\
UCEC & UCEC\_1q & MPZL1 & 0.52 & 0.30 & 195.0 & 127 & 1 & -0.22 & passenger & high \\
UCEC & UCEC\_1q & ADAM15 & 0.42 & 0.32 & 199.0 & 490 & 1 & -0.08 & passenger & high \\
\bottomrule
\end{tabular}
}
...
\midrule
LUAD\_7p (EGFR+ITGB8+TSPAN13+TTYH3) & 4-valent & measured & 1.45 & 1.18--1.70 & 0.001 & 41615 / 130 & yes \\
LUAD\_7p passenger-only (ITGB8+TSPAN13+TTYH3) & trivalent & measured & 1.30 & 1.13--1.47 & 0.001 & 41615 / 130 & yes \\
LSCC\_1q (HSD17B7+MPZL1+NCSTN) & trivalent & measured & 1.15 & 1.01--1.6 & 0.001 & 33234 / 42 & yes \\
GBM\_19p (ATP13A1+TMED1) & bivalent & prediction-only & 1.12 & 1.08--1.19 & 0.001 & 390761 / 208 & yes \\
GBM\_20p (ATRN+PTPRA) & bivalent & prediction-only & 1.1 & 1.06--1.13 & 0.001 & 390761 / 208 & yes \\
GBM\_7q (MET+SLC12A9+SLC4A2) & trivalent & prediction-only & 1.1 & 0.95--1.3 & 0.001 & 390761 / 208 & yes \\
LSCC\_3q (ATP11B+TFRC) & bivalent & measured & 1.09 & 1.04--1.18 & 0.001 & 33234 / 42 & yes \\
...
LUAD\_1q (ADAM15+NCSTN) & bivalent & measured & 0.99 & 0.96--1.02 & 0.8432 & 41615 / 130 & yes \\
UCEC\_1q (ADAM15+MPZL1+NCSTN) & trivalent & measured & --- & --- & --- & --- & nominated \\
\bottomrule
\end{tabular}
}
...
depmap & DepMap/CCLE & \textasciitilde{}1,100 cell lines & CRISPR dependency --- essentiality liability; dosage features (DepMap/CCLE) & built \\
...
\midrule
recurrent amplicons & 497 & 40 \\
co-elevated genes (FDR<0.1) & 825 & 93 \\
transmitted genes (obs>=0.40) & 2895 & 823 \\
co-elevated \& transmitted & 606 & 87 \\
of 22 nominated antigens surviving & 18 & 5 \\
\bottomrule
\end{tabular}
}
\caption{\textbf{Amplification-threshold sensitivity}}
\label{tab:threshold}
\end{table}
...
\midrule
LSCC-LUAD & 632 & 0.82 & 3.27e-152 \\
LUAD-UCEC & 351 & 0.66 & 8.29e-45 \\
LSCC-UCEC & 351 & 0.55 & 1.86e-29 \\
CCRCC-LSCC & 50 & 0.19 & 1.78e-01 \\
CCRCC-LUAD & 308 & 0.11 & 5.26e-02 \\
\bottomrule
\end{tabular}
}
